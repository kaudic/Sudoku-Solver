...
router.get('/account/create', controller.formCreation); //Formulaire de création de compte
router.get('/account/:login', controller.displayAccount); //afficher les infos de compte et pouvoir les modifier
